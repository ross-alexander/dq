...
- 10,000 silver pennies + unwanted loot (half up front)
- Hired by Callas
...
- Artephius (Ed)
- Sin (Trish)
- Etheric Glacier (Catalysm Earth)

- Choir (24 people)
- Sexton
- Concert Master (Circus Maximus)
...
- Find two Fulmanite stones, Callas & Slaydar take one each
...
- Henry has two spell racks
- One is a dream capture, first healing spell of the gain adds +3 points
- Cloak as Air Aspect
- Trade for Pot of Beauty Flesh
- Do Military Scientist

- Ask Astrologer Specific Question "Where to find a Choir of the House
  of Fire": Eastern side of the land of Nod, before the House of Jade.
...
## Session 21 - 2026.06.21

- Animate spider corpse

- Use Rank 9 Restorative and 10 point healing

- Return to room 14 then head north

- Enter room 9, two wooden doors to the west

- Shallow pit in the center in the room, with tools, some bronze

- There was machinary or shelving against the walls but now missing

- Had some sort of power source, maybe steam or nuclear

- Find a bronze spanner

- Head towards to room 12, wooden door

- East side is a wooden door, archway to the north

- Nothing in room 12 so head up to room 7 to the north

- Anvil and forge to the SW, secret door on the north, anvil is not steel

- Forge tray is 12lb with anvil 70lb

- Rusted iron box

- Unlock box, there are three items and three incantations

- Go east from room 7 into room 11 through an unlocked stone door

- Iron door to in the NE corner

- Shrine but now ruined and defaced, not come across before but not
  known to be bad

- Find a silvered breastplate (8pt and light), bronze scalemail shirt,
masterwork bronze trumpet and alchemy recipe for smoke sticks, a
brown-green garnet (100gs)

- Looks like vistors dorm room

- Leave offering of fruits and nuts

- Head out of NE door and find a shaft down to a plundered tomb

- Geoff sets off a lightning ward

- More demonic faces painted on the wall, one in a certain light is an
old man with a long white beard, very faint magical aura (colour)

- Reach a wooden door with a rank 8 lock, which Ishamael successfully
  unpicks

- Room is a former wierd laborary with a depression in the center

- Simon is pulled into the pit by a black tenticled something

- Use sleep dust but doesn't work, grabs second zombie

- Blackfired and Hand of Death

- Use necrotic poison

- Use death point and Hecate's Talon

- Defeat blob

- Search remaining rooms and find no more creatures
...
## Silver Emblem of Sin

This silver crescent plaque is 3 cms wide from point to point and is
1.5 cms wide at its thickest where it is blazoned with
\textcuneiform{𒌋𒌋𒌋}.  Two small pearls are set beneath each of the
points, and four small moonstones arranged below the blazon and along
the curve of the plaque.

All of the gems have been awoken.
...
Effects
: This pearl allows the bearer to use their Cure Endurance ability as
a Pass Action.  Once used, it resets on the next moonrise, if there is
one.
...
Effects
: This moonstone makes the bearer immune to all magic, beneficial or
  otherwise, for the next three Pulses. At the end of this time, all
  magic that was in effect is reasserted.

Once used, it resets at dusk on the first night of the dark of the
moon.
...
Effects
: This moonstone suspends the passing of time for thirty days in a
  diameter of 15, 25 or 35 feet across. This reduces the bearer's
  Endurance value by 10, 15 or 20, respectively. This loss may only be
  recovered by Natural Healing. Anyone within the volume is able to
  act as normal, but the effect ends after thirty days have passed or
  if they leave the volume, whichever happens first, and this ends the
  Pulse if combat had been engaged.

Once used, it resets at dusk on the Autumnal Equinox.
...
Target
: Entity, object or surface

Duration
: Immediate, during Pulse

The bearer touches this moonstone to an object, entity or surface to
perform a Divination or an Ancient Divination. If it is a Divination,
then the Cast Chance is 100%, otherwises it is automatically
successful.

Once used, it resets at midnight on the next equinox or solstice.
...
This pearl causes moonlight to suffuse the bearer's hex for a Pulse.
Anyone who is either Solar or Lunar aspected within 125 feet will
immediately be aware of it, with Solar aspected entities adding 5 to
the results of their percentile checks, and Lunar aspected entities
subtracting 5 from them for so long as duration persists.

Once it is used, it resets after the passing of three dusks.
...
Effects
: The bearer attempts to Strike a lycanthrope, shapechanger or entity
  under the effects of magic that transfigures, transforms, polymorphs
  or similar. If successful, they may use a Free Act to trigger this
  moonstone, which will return the target to their orginal form unless
  they Break 100, adding their WP to the result, to avoid it.

Alternatively, if the bearer takes 18 hours in contemplation of Sin,
they may remove the curse of Lycanthropy from their target or convert
a Shapechanger lost in their beastform to a normal human. This will
also convert their Racial Tax modifier to 1.

No Cast Check is made, it is automatically successful. The target
loses their Lunar aspect if they had one, and must roll for a new
Aspect until they generate one that is not Lunar.

Once used, it resets at dusk of the moonrise on the next Monday, if
there is one.
...
with gopherwood resin from the land of Goshen. The PS to wield this
bow is 14, the MD needed is 15, and it weighs 4 lbs. In the hands of
other races, it is a shortbow. It has a base Strike Chance bonus of
+12 and damage is increased to a rollup D10 + 3. If the die roll
result of a Strike Check is 15% or less of the modified Strike Chance,
then an A Class Specific Grievous injury is rolled for. If it falls
within 25%, it is a strike directly to Endurance.  In the event of a
possible Specific Grievous injury, then even if such an injury is not
generated, the total damage is tripled.

For hobbits alone, this is a finesse weapon, so that for every 5
points of MD greater than 15, damage is increased by 1, bonuses for
excess PS are never applied and for any other race, it can only be
fired six times a day.

## Breastplate of Kenite Iron

This breastplate is large enough to fit a humanoid of size 6, and
weighs 4 lbs. It is lighter and more resilient than steel and prevents
the wearer from using their non-racial spells, talents and rituals.

It can be worn over the top of other leather, scale mail or chainmail,
but not exotic armour like dragonskin and the like.

If the wearer takes damage from a Fatigue blow that ends in 3, 4, 5,
6, 7 or 8, they increase the Prot value of their armour by 4,
potentially avoiding some or all of it.

The wearer has a 30% chance to entirely avoid a Specific Grievous
injury that afflicts their torso:

11
: Your aorta is severed and you are quite dead. Rest assured your
  companions will do their best to console your widow(er).

12
: A stomach puncture. Nasty. You suffer 3 Damage Points immediately
  from Endurance and lose 2 from your TMR until fully recovered, which
  will take two months. Also, you are automatically stunned for the
  next pulse (if you aren’t already), after which you may
...
reduce your TMR by 1 until recovered (about 2 months). Look on the
bright side, though. Your attacker’s weapon is caught in your rib cage
and has been wrenched from their grasp.  37–40 You have been
eviscerated! Take 4 Damage Points immediately from Endurance and 1
point per pulse from Fatigue thereafter (Endurance when Fatigue is
exhausted) until you are unconscious. Increase your chance of
infection by 40.
...
This bronze scale byrnie is a flexible coat of small, oblate bronze
scales that weighs 18 lbs. It can be worn over the top of other linen,
leather, scale mail or chainmail armour, but not exotic ones like
dragonskin or similar. If the wearer takes damage from a Fatigue blow
that ends in 3, 4, 5, 6, 7 or 8, they increase the Prot value of their
armour by 3, potentially avoiding some or all of it.

## Brass Trumpet

This brass horn weighs 2 lbs 5 oz and is 4 1/2 feet long. One like
this might be bought for 2tsg, 12 gs, 4 sp.
...
Adventuring Skill if he has the Experience to pay for it.
...
| WP         | PC         | PB         | TMR        | NA                      |
+------------+------------+------------+------------+-------------------------+
| 12         | 9          | 17         | 7          | Fur absorbs 2 DP        |
+------------+------------+------------+------------+-------------------------+

Weapons
 ~ Claw: BC: 25%, [D10 - 4], B Class damage, Melee & Close, Ranks as Cestus
 ~ Sting: BC: 40%, [D10 + 1], B Class damage, Melee & Close, Ranks as Falchion
 ~ Spines: BC: 40%, [D10], A Class damage, Ranged, 12 Hexes, Ranks as Crossbow

Furze can deliver a Sting and 2 Claw attacks in Melee. In Close, he
can make a Sting attack and 4 Claw attacks.

He has 6 spines which he can fire from his tail 1 at a time. He has a
70% chance of regrowing a spine at dawn, 2 if he rolls 30 or less.

### A year later

Description
: Furze' body is now the size of a clouded leopard at 2 feet 11 inches
long, with the tail and stinger adding 2 foot 6 inches to his
length. His wings are dark auburn in colour, their span is 4 ft 9 in
that fold down into form fitting 'cape' from shoulder to haunches. He
weighs 21 lbs. Faint light brown rosettes have filled in on his body
over a base colour of pale grey/fawn. His shoulders are covered with
long soft hair, ash blond in colour. His features have matured
somewhat, his nose and chin being slightly more pointed and he has a
darker, more tanned aspect, now.

Comments
: He has the mental development of a 12 year old boy but cannot learn
a language. He believes he would look particularly fetching in a red
fez with gold tassels.

Abilities
: He can fly but not well and he must spend 1 FT for every hour of
  flight or part thereof. In particular, he cannot stay airborne at
  speeds of 6 TMR or less, so cannot deliver a flying attack, evade or
  use a Pass Action in flight, regardless of his Rank with the
  Adventuring Skill.

Movement rate
: Running 400 yards per minute, Flying 40 mph
...
| WP         | PC         | PB         | TMR        | NA                      |
+------------+------------+------------+------------+-------------------------+
| 14         | 12         | 18         | 8/12       | Fur absorbs 2 DP        |
+------------+------------+------------+------------+-------------------------+

Weapons
 ~ Claw: BC: 35%, [D10 - 2], B Class damage, Melee & Close, Ranks as Cestus
 ~ Sting: BC: 50%, [D10 + 3], B Class damage, Melee & Close, Ranks as Falchion
 ~ Spines BC: 50%, [D10 + 1], A Class damage, Ranged, 15 Hexes, Ranks as Crossbow

Furze can deliver a Sting and 2 Claw attacks in Melee. In Close, he
can make a Sting attack and 4 Claw attacks.

If the Sting does effective damage, envenomation occurs. The venom
does no damage, but inflicts pain, adding 1 to the result of a Strike
Check or Cast Check.  This is cumulative and lasts until a scorpion
antivenin is applied or 4 hours have passed.  His venom sacs hold 6
doses, and he recovers 1 each dawn so long as he is well-fed.

He has 8 spines and he can fire 2 at a time at the same target or
another he can see in front of him. He has a 70% chance of regrowing 2
spines at dawn, 3 if he rolls 30 or less.

### Maturity

Description
: At three, Furze has achieved his adult growth, although his PS, MA,
  EN and FT will increase by one on each of his next five birthdays as
  his skeleton, musculature, metabolism and mind develop to full
  adulthood. His body is about the size of a snow leopard's at 3 ft 6
  in long, the tail and stinger being a further 3 ft 2 in. His
  rosettes are the colour of cinnamon and the base colour is pale
  gold. His wings are deep crimson and span 9 ft 4 in that fold down
  into form fitting 'cape' from shoulder to haunches, weighing 40
  lbs. His shoulders are covered in a tawny mane which will become
  larger over the next five years until it is the same as a
  lion's. His nose is now more aquiline and his lower jaw has filled
  out with his chin being more pronounced and broader. His skin tone
  is generally tanned, dark olive.

Comments
: If he does not yet have a red fez with gold tassels, there will be Hell to pay.

Abilities
: Furze may be an adroit flyer depending on his Flying Skill. He can
  sustain flight at half his TMR and, if he pays 1 FT each Pulse, he
  can fly slower than that or even hover by flapping strenuously. He
  may use Stealth while flying except when beating his wings. His
  maximum level flight speed is 50 mph. In a stoop, he can achieve a
  speed of 120 mph. If he pulls out into level flight, he can
  gradually slow down to 15 mph or slower over 12 Pulses and cover
  3,280 feet (1 kilometre). He may take a Pass Action to slow down
  over a Pulse, requiring a Flight Check with a penalty of his speed
  in mph and at full dive speed, will cover 150 feet.

Movement rate
: Running 450 yards per minute, Flying 50 mph
...
| WP         | PC         | PB         | TMR        | NA                      |
+------------+------------+------------+------------+-------------------------+
| 16         | 15         | 19         | 9/15       | Fur absorbs 3 DP        |
+------------+------------+------------+------------+-------------------------+


Weapons
 ~ Claw: BC: 40%, [D10], B Class damage, Melee & Close, Ranks as Cestus
 ~ Sting: BC: 55%, [D10! + 5], B Class damage, Melee & Close, Ranks as Falchion
 ~ Spines: BC: 55%, [D10! + 2], A Class damage, Ranged, 20 Hexes, Ranks as Crossbow

Furze can deliver a Sting and 2 Claw attacks in Melee. In Close, he
can make a Sting attack and 4 Claw attacks.

He can deliver a Sting attack as a function of a Dive, which will
increase his Strike Chance by 20.

If the Sting does effective damage, envenomation occurs. The venom
does no damage, but inflicts pain, adding 1 to the result of a Strike
Check or Cast Check. This is cumulative and lasts until a scorpion
antivenin is applied or 4 hours have passed. His venom sacs hold 12
doses, and he recovers 2 each dawn, so long as he is well-fed.

He has 12 spines and can fire 3 at a time at the same target or up to
2 others that he can see that are in front of him. He has a 70% chance
of regrowing 2 spines at dawn, 4 if he rolls 30 or less.

His PS, MA & EN increase by 1 each year for the next five years, when
he will have achieved his full adult growth.

If properly motivated, he may become a loyal follower and may assign
to whoever he follows a parental role. That will change in the next
stage of his development, where he is larger, can fly albeit with
little grace, is more of a physical threat and is more intelligent. He
is also more demanding, stroppier, interested in things that improve
his appearance and personal sense of style. Constant praise is also
acceptable.

Upon maturity, he will want at least a half share in treasure,
including gear. Unless he develops some, he has no Language Skills but
he can definitely count and he is intelligent. At this point, he is no
longer a follower, but sees himself more as a companion and business
partner. He will take every opportunity to learn the Merchant Skill,
whereupon his first Speciality will be *Mercenary Contracts*.

Furze is mortal, even though he is a Fantastical Beast, and has a
lifespan of 70 years. If he dies before his allotted span, he can be
Resurrected if someone with that ability can be found.

He earns 20% of his companion's Experience but only one training
track, the rest of his time spent on things vital to manticore
'development'. At a rate of 1 per adventure or season, whichever is
least, any of his Primary Characteristics except AG can be advanced 5
more points additional to any he acquires as a result of ageing or the
like. He may advance his PC to a maximum of 23 and there is no upper
limit to which his FT value may improve.
...
Whoever drinks from this amphora will be wracked with convulsions,
losing 1 point of EN a minute for five minutes. After drinking from
the amphora, the mark of belladonna flower can be found on the
inside. If they do not die, they acquire this permanent ability, which
will endure past death.

### The Form of Jafar's Viper

The Adept and 30lbs of their carried equipment transfigure themselves
into a venomous snake by taking a Magical Pass Action. Magic that is
still in effect apply in viper form, but the benefits of the bearer's
gear do not, unless specified otherwise. As a viper, the Adept cannot
speak nor cast Spells or Rituals. They can use Talents that don't
require gestures or vocalisations (e.g. Not Ask the Dead, etc.). They
can make use of these Skills:

 * Navigator (except Map Creating, Piloting, Maintaining the Speed of
   a ship or Recognising Nonmagical Danger at sea)
 * Ranger (except Brew Tisanes, First Aid or Preparing Food). They
   have an environmental specialisation in deserts and improve their
   Stealth there by a further 10 points.
 * Assassin (except Using Envenomed Weapons, Increased Grievous
   Injury, Torture, Buy Poisons etc. at cost, Inflict Increased
   Damaage from the Rear, Increased Knockout Chance)
 * Spy (except Bribery, Disguise, Forgery, Imitation, Pick Locks or
   Sleight of Hand)
 *  Thief (except Pick Locks/Open Safes, Remove Traps, or Pick Pocket)

Descriptions
: Jafar's Vipers are 2 feet long and weigh 10 oz. They have amber and
cream coloured scales in the shape of diamonds along their lengths,
blunt heads and fangs half an inch in length.

Comments
: The viper
 * adds their serpentine AG to their Initiative roll.
 * can 'sidewind' at a short term movement rate of 300 yards per minute or 6 TMR.
 * may cover 15 feet in a *Serpent Strike*, additional to any other
   movement it is entitled and this will increase their Strike Chance
   by 20. Once used, this ability cools down for 3 Pulses
 * holds a store of 9 doses of venom lethal to an adult human, which
   will regenerate at a rate of 2 per day. In this form, the Adept may
   release venom to make an antivenin against the poison of vipers
 
 * adds 10 to their Stealth and can slip through a crack no less than
   half an inch by 1 inch.
 * has a standard movement rate of 175 yards per minute and can climb
   over natural obstacles at 50 yards per minute

+------------+------------+------------+------------+------------+------------+
| PS 	     | MD         | AG         | MA         | EN         | FT         |
+------------+------------+------------+------------+------------+------------+
| 2          | 5          | 25         | Adept's    | 13         | Adept's    |
+============+============+============+============+============+============+
| WP         | PC         | PB         | TMR        | NA                      |
+------------+------------+------------+------------+-------------------------+
| Adept's    | Adept's    | 13         | 6/1        | Scales absorbs 3 DP     |
+------------+------------+------------+------------+-------------------------+

Weapons:
 ~ Bite: BC 40%, [D10!], Melee or Close, A Class Damage, Adept's Rank in Dagger.

The fangs are particularly sharp and ignore the first 3 points of
Protection before damage is rolled. If effective damage is taken, it
is a bleeder inflicting 1 DP per Pulse and envenomation occurs.

The immediate effect of the venom is to increase damage by 1 for each
bleeder. If the victim survives this, then after an hour, there is a
30% chance that the victim will be unable to urinate.

If they are able, then their urine will be copious and as red as port
wine. In either case, their EN value is reduced by half, rounding
down, but once urine is passed, they may begin to recover.

If they cannot urinate, their EN value is reduced by half at dawn,
until they receive a viper antivenin or are treated by a Healer who is
at least Rank 7 or their EN value is exhausted. By the third morning,
the pain is sufficient to make death a preferred state.  While
envenomed, they may not be Healed of DP, although FT may be
Transferred to them.

Defences
: Jafar's Vipers typically assume a 'stance' by turning intertwining
  loops into a confusing lemnis, weaving their heads back and
  forth. This adds 10 to the result of any opponent's Strike Check,
  making it more difficult, and can be combined with an Evasion.

Whenever they return to their original form the Adept halves their
current and maximum FT value (rounding up). This is cumulative, their
maximum FT resetting to the original value at dawn, although their
current FT value is unchanged until it is restored by rest or
medication.

## Pentagram of Interment

Range
: Touch

Duration
: Two weeks per Rank, 1 year at Rank 20
...
Target
: A volume 5 hexes across and 3 hexes high
...
Effects
: The Adept must spend three hours (-10 minutes per Rank, min. 10)
  communing with the Underworld and focussing their spiritual
  resources upon the bones of at least one entity to prepare a
  Pentagram of Interment. If they have the Spectral Warrior spell,
  they may bind one to the pentagram for the duration of the
  Ritual. The warrior will automatically attack any entity within the
  pentagram who attacks the Adept.

The Adept may use the Spectral Warrior at a Pentagram of Interment to
open a spectral pathway through the Valley of Death to an active
Pentagram of Interment of their creation, which must be within Rank ×
Rank × 10 miles. The portal allows them to transport themselves (+1
entity per 2 Ranks of the spell). From the perspective of the
travellers, they will be travelling at a walking pace through the
mist-shrouded Valley of Death, but in reality, they will travel at a
rate of Rank miles per minute for Conc. Max: 10 mintues × Rank of the
spell, min. 10.

While the Ritual is less than Rank 10, this will dissipate the
spectral path and the Warrior. After Rank 10, it will dissipate the
spectral path and exhaust the Warrior, who will recover by midnight
after the the travel completes. At Rank 20, it dissipates the path,
but does not exhaust the Warrior.

The Ritual always fails if either the departure point or the
destination is death free for whatever reason. The Adept may make the
Pentagram permanent by sacrificing a point of PC to it. If there is no
Spectral Warrior bound to it, however, no passage through the Valley
of Death is possible until one is so bound.

Cost
: 120 tsg.

## Draught of Dispelling Transfiguration

This colourful stoneware amphora is 6 inches tall and weighs 11
oz. The lid is sealed with pine sap resin and holds up to 5 fluid
oz. Whoever drinks it has their nature changed so that they are able
to return to their original form (requiring a Pass Action) if they are
transformed into a frog by any means. This ability is permanent and,
since it has changed their nature, persists beyond death. If they are
DAed and the name of the magic they are under the effect of is asked
for, the answer will always be 'Dispelling Transfiguration',
regardless of any other magic.

Once the concoction has been drunk, the mark of a pair of entwined
thorny vines is revealed inside the amphora.

## The Egg in Jet

Pskaithe is an intelligent, fell beast from a culture lost in the
mists of time. He can recall a realm where enormous creatures stalked
the land and the air was heavy with the perfume of lost eons. He
claims to have been a simple merchant of the House of Psabeq in the
Dynasty of Abep'is-Tau, but he knows that an enemy cursed him so that
his ageing was reversed which him forced back into his egg. He mutters
direly about the vizier of Djedd Uwengath but won't be drawn further.

His egg was struck by pilot waves propagating from an invading
reality, the wave function collapse interacting with his curse, which
separated his body from his soul. He would have passed on, but bound
to his egg, he eventually found himself in the northern region of the
Land of Nod.

He has spent time observing this new world as his senses expanded from
his new locus. In time, he made the acquaintance of Shemyaza of the
Grigorii. He gives the impression that a great deal of time passed
before trust was established, but when it was, Shemyaza and others of
his order worked with Pskaithe to better understand what he
described. Unfortunately, his knowledge of things that happened after
this has been compromised and he no longer trusts his memories.

His egg, once mired in tar, has fossilised into jet, was torn from a
vein in what is, now, the Black Sands desert.

When the jet is lit, fumes from aeons past issue forth. If this smoke
is targetted with a spell of Animating Bodily Parts, then Pskaithe
will form around the Adept as a construct of smoke.  This will last
for 20 minutes (+20 minutes per Rank), becoming ordinary smoke once
the spell ends.

Physical Form
: Pskaithe's head is 3 feet long with a 1.5-foot beak, his neck is 5
  foot long and serpentine, his body is 7 feet, with an 8 foot long
  tail. His wingspan is 25 feet.

Insubstantiality
: He is insubstantial except to those things capable of reaching 60
  million years into the past. Aside from providing flight to the
  Adept, he is largely transparent to the temporal world.

Flight & Launch
: Unless facing into a headwind or launching from a height of at least
  20 feet, he must achieve a land speed of 12 TMR to take to the air.

Aerial Movement
: Once airborne, his TMR is 8 (increasing to 9 at Rank 10, and 10 at
  Rank 20). Level flight speed is 30 mph (+1 mph per Rank), reaching
  120 mph in a stoop. He can fly as slow as 3 TMR, but this requires
  strenuous flapping and costs 1 FT per Pulse.

Deceleration
: If he pulls out of a 120 mph stoop into level flight, he can coast
  to 15 mph or slower over 12 minutes, covering 9
  miles. Alternatively, he may take a Pass Action to air-brake over a
  single Pulse. This requires a Flight Check with a penalty equal to
  his current speed in mph and covers 270 feet if attempted at 120
  mph.

Encumbrance & Cargo
:  Pskaithe can carry the Adept and an additional 30 lbs ( +1 lb per
   Rank) without difficulty. He can also carry heavier amounts, to a
   maximum of 50 lbs (+ 5 lbs per Rank), each 50 lbs or part thereof
   costing the Adept 2 additional FT per hour of flight. Aerobatic
   manoeuvres while bearing cargo doubles the result of the Flight
   check, making it more difficult.

The fossilised egg is a legal target for the Ritual of Life
Prolonging, drawing jet to cover it which, upon completion, reseals
the vessel.

## Horned Jackal Ring

The band of this ring is carved out of sardonyx, the bezel is formed
out of gold and weighs 3 oz. It is in the shape of a jackal's head
with a horn the shape and size of a stiletto emerging from its
forehead. The mark of a pair of entwined thorny vines can be found on
the reverse side of the bezel. After it has been in the bearer's
possession for the passing of a full moon, it's magic becomes
available to them.

It must be worn on the ring finger of the left hand for its magic to
be effective. When it is, the bearer and 30 lbs of their gear may
transform into a horned jackal with fur the colour of sand in
sunlight. This requires 1 FT, a Magical Pass Action and a Free Act and
to utter a sharp bark. Magic in effect still applies, but the benefits
of the bearer's equipment do not, unless specified otherwise.

They may stay in this form so long as they keep spending 1 FT each
hour or part thereof. As a jackal, the bearer cannot speak nor cast
Spells or Rituals. They can use Talents that don't require gestures or
vocalisations (e.g. Not *Ask the Dead*). Transfigured, they can make
use of these Skills:

 * Navigator (except Map Creating, Piloting, Maintaining the Speed of
   a ship or Recognising Nonmagical Danger at sea)
 * Ranger (except Brew Tisanes, First Aid or Preparing Food). Even if
   no other trace is present, may track by scent alone without
   penalty, even across snow. They have an environmental
   specialisation in or around ruins which is additional to any other
   that the bearer might have, and improve their Stealth in the desert
   by 10.
 * Assassin (except Using Envenomed Weapons, Increased Grievous
   Injury, Torture, Buy Poisons etc. at cost, Inflict Increased
   Damaage from the Rear, Increased Knockout Chance)
 * Spy (except Bribery, Disguise, Forgery, Imitation, Pick Locks or
   Sleight of Hand) Thief (except Pick Locks/Open Safes, Remove Traps,
   Pick Pocket, Climb)

Horned jackals can maintain a ground-eating pace of 10 mph for hours
at a time. Once a day, resetting at dawn, they can sprint 24 hexes in
a Pulse without losing the benefit of their Magic Resistance or
Defence.
...
| PS         | MD         | AG         | MA         | EN         | FT         |
+------------+------------+------------+------------+------------+------------+
| 7          | 10         | 24         | Bearer's   | 16         | Bearer's   |
+============+============+============+============+============+============+
| WP         | PC         | PB         | TMR        | NA                      |
+------------+------------+------------+------------+-------------------------+
| Bearer's   | Bearer's   | 9          | 9          | Fur absorbs 2 DP        |
+------------+------------+------------+------------+-------------------------+

Weapons

 ~ Bite: BC: 65%, [D10 + 1], B Class damage, Close, Rank is equal to
 the bearer's Rank in Unarmed Combat

 ~ Horn: BC: 50%, [D10! + 2], A Class damage, Melee/Close, Rank is
 equal to the bearer's Rank in Dagger
 
The jackal may Charge up to their full TMR and deliver a Horn attack,
increasing their Strike Chance by 20 and their damage to [D10! + D5! +
2].

The horn of the jackal is much sought after. A Wiccan, Shaper or
Talismonger can make an amulet from it that will provide a 20 point
bonus with respect to the bearer's court cases and their chance to
Resist the Evil Eye.

## Antediluvian Tortoise

This shell and skeleton are the remains of a massive testudine 10 feet
long, 7 1/2 feet wide and 6 feet high. Its upper carapace is comprised
of pentagonal scutes. In life, it would have filled a volume of 75
cubic feet and weighed 4,400 lbs occupying three hexes on the combat
grid. However, since only its skeleton and shell remain, it occupies
12 cubic feet and weighs 1,235 lbs, although it still occupies three
hexes.

The remains have been treated with experimental unguents and elixirs
which carry the mark of a pair of entwined thorny vines, which has
preserved and improved their inegrity. As a consequence, the remains
do not turn to dust when the Animating magic ends. Additionally, the
shell now reduces physical *and* magical damage, and the oils of the
unquent have brought out the deep greens, reddish-browns and
translucently gold-flecked mottling of the carapace. Consequently, the
testudine's PB is insufficient to force a Fright check. Its movement
rate and TMR have also increased as a function of its enhanced power
to weight ratio.

It is resistant to A & B Class damage, halving it before Damage
Reduction and Protection (if any) is applied. In addition, it is
immune to A Class Specific Grievous injuries and many B Class ones. It
has the usual traits for lesser undead and recovers 3 EN every 2 days
that it rests (defined as a day in which it loses no more than half
its FT). Undead do not sleep, eat or drink so only recover FT by
resting, which, in this case, restores 1 1/2 points an hour.

It cannot be Healed by Skill or Spell nor consume Healing Potions or
the like. An Adept who can Cast the Warping spell can repair Specific
Grievous injuries if their Skill in Beastmastery includes turtles &
tortoises and is equal to the Rank that a Healer would need to make
the necessary repairs. As it happens, skeletal undead rarely suffer
damage to muscles, nerves or vital organs. Amputations, however, can
be bothersome. Warping cannot repair non-specific damage to EN or FT.

The internal dimensions are 6'8" long x 4'2" wide x 4'6" high.
...
| WP         | PC         | PB         | TMR        | NA                        | 	
+------------+------------+------------+------------+---------------------------+
| 14         | 18         | 8          | 5          | Shell reduces damage by 12|
+------------+------------+------------+------------+---------------------------+

Weapons
 ~ Bite: BC: 25%, [D10! + 2], C Class, Melee & Close, Rank 0

It uses this Encumbrance Table

+-----------+--------------------------------------------------+-----+
| PS        | Weight of Load (lbs)                             | Max |
+===========+=======+======+=====+=====+=====+=====+=====+=====+=====+
| 43        |  157  | 204  | 321 | 407 | 493 | 595 | 673 | 736 | 783 |
+===========+=======+======+=====+=====+=====+=====+=====+=====+=====+
|           | Fatigue Loss per hour                                  |
+===========+=======+======+=====+=====+=====+=====+=====+=====+=====+
...
and its TMR is penalised by 1 for every 3 full points of AG lost.

## Catspaw and Shrike

These weapons are paired, and if unbound, have no discernible magical
properties unless Divined. Upon binding them, a potenntial wielder
must stab themselves with both in the same Pulse. If this kills them,
then the binding fails.

Whereas Catspaw is a main gauche, has a reverse curve and inflicts B
Class injuries (except for decaptitations), Shrike is a stiletto-like
dagger that inflicts A Class wounds. Both are finesse weapons, damage
is not modified by PS, instead, every 5 points of Manual Dexterity in
excess of the minimum needed to wield them adds +1 to their damage.

The base Strike Chance of Catspaw is 45%, inflicts 1 rollup D10 + 1
damage and weighs 1 lb. The base Strike Chance of Shrike is 40%,
inflicts 1 rollup D10 damage, has a range of 12 hexes and weighs 10
oz.

Each weapon can take the form of the Dark Aspected Living Animals
listed below. While each are wielded as weapons, the MD of the form is
added to the MD of the hand it is wielded in.

In the form of animals, their aura strength is "Living Animal", their
GTN will be as a normal beast of their kind and the response to any
question about their magical properties will be "no answer", which
will be the same response to a question about their gender. They can
be affected by magic that targets Living Animals, but not by magic
that specifically targets sentients (like Control Person), even though
they are. They can be directed when in animal form but use their
individual MD, only, and no penalties are applied for want of PS. If
their wielder can communicate with them, they may give new
instructions while they are within range, requiring either a Free Act
or a Pass Action.

### Catspaw

Description
: This main gauche can take the form of a small, dark, tortoiseshell
housecat with lambent green eyes weighing 5 lbs when it is dropped to
the ground and its name spoken.

Abilities
: Catspaw's Stealth is 4 x AG + 6 x the wielder's Rank with main gauche.

If it

 * shares the same hex as the person that it is bound to, it provides
   its usual bonus to melee Defence, but which immediately fails if
   any other shield or main gauche is used.
 * enters the hex of a bipedal opponent of size 9 or less, which it
   can do without provoking an attempt to keep it out of Close, then
   it can force the opponent to make a 3 x AG roll or fall prone as it
   runs between their legs.
 * succeeds in a rear attack, it inflicts 2 x the wielder's Rank in
   Assassin in addition to its other damage.

Comments
: It has a movement rate of 450 yards per minute while running, and
  can climb natural terrain and obstacles at 250 yards per minute.
...
| WP       | PC       | PB       | TMR      | NA                  |
+----------+----------+----------+----------+---------------------+
| 11       | 15       | 18       | 9/5      | Fur absorbs 2 DP    |
+----------+----------+----------+----------+---------------------+

Touching Catspaw and uttering its name will turn it back into a main
gauche otherwise it will change back at dawn or upon death. Death ends
the binding, rendering it a non-magical main gauche. It may be rebound
as above on the fifteenth day of a subsequent month.

### Shrike

Description
: This dagger can take the form of a bird when it is thrown into the
  air while speaking its name. Shrike has dove grey plumage, with
  black feathers on its leading edges and tail. It has a black mask,
  is 9 1/2 inches long, a wingspan of 13 inches and weighs 2 1/2 oz.

Abilities
: Shrike's normal pattern of flight is to hug terrain and then rise to
  attack.

It can:

 * move its full TMR for a Pulse while under cover of Stealth, the
   chance being 3 x AG + 5 x the wielder's Rank in dagger. Once used,
   the technique cools down for 3 Pulses.
 * deliver a flying Charge, moving up to its full TMR, increasing its
   Strike Chance by 20 and doubling damage if it hits.

It has 3 times the visual acuity of a human, can see into the ultra
violet, and its black mask adds 10 to its chance to resist glare or
being dazzled. It improves its chance of spotting movement by +1 to
the PC multiple, so at 500 feet, has a 3 x PC check to identify, say,
a postage stamp or grape, or 4 x PC check for a bumblebee in flight or
a jumping grasshopper.

Comments
: It has a movement rate of 600 yards per minute while flying below 500
feet. Above this, it flies at up to 45 mph with a flight ceiling of
16,000 feet.
...
| WP       | PC       | PB       | TMR      | NA                    |
+----------+----------+----------+----------+-----------------------+
| 19       | 18       | 8        | 12       | Feathers absorbs 2 DP |
+----------+----------+----------+----------+-----------------------+

Touching Shrike and uttering its name will turn it back into a dagger
otherwise it will change back at dusk or upon death. Death ends the
binding, rendering it a non-magical dagger. It may be rebound as above
on the fifteenth day of a subsequent month.

Neither are legal targets for weapon spells.

## Medicine Bag

This small greenish bag is made from leather with 5 inch long leather
tassels of the same colour. It has a long strap allowing it to be worn
over the shoulder. The flap unfolds to an opening 9 inches by 3 inches
and is 8 inches deep. A Shaman may use it to hold fetish objects, for
example, totem figures, carved animals, feathers, skin, skulls, bones,
fangs or claws of creatures smaller than a dog, red ochre, black sand,
crystals, pebbles, leaves, roots, seeds, dried flowers, grass but
particularly psychoactive substances and tobacco. These are usually
found while foraging (as the Ranger Skill) but they might find such
things anywhere. If the DM has decided there is one nearby, the
Shaman's chance is PC × 2% (+ 5 × Rank) to spot it. No more than one
fetish can be found each day. Although they are not magical, they can
be used to:

* pay part of the FT cost of a spell, making it cost 1 less FT to a
  minimum of 1.

* pay for a service from one of their attending spirits.

The medicine bag holds a single fetish and requires the Shaman have an
unmodified MA of 16 or higher. To increase its capacity, they must
sacrifice 1,000 Experience divided by (their unmodified MA - 15) to
it, doubling each time.

## Energy Crystal × 3

This object is a crystal orb 2 inches across and weighs 6 1/2
oz. Astral energy has been stored in the crystal so that when it takes
magical damage, it will detonate for 2 rollup D10 spell damage over a
diameter of 25 feet. Each extra orb adds 2 more rollup D10 but not the
diameter.
...
This Ulster Cloak reaches to the knee, has a high collar and an
overmantle that covers the shoulders down to the middle of the
back. It is lined with the feathers of rooks, and although it looks
like a heavy leather cloak, it weighs only 11 oz.

It is Air Aspected, and allows the wearer to reduce their flying speed
to as little as 3 Hexes per Pulse before stalling and beginning to
fall, if they are flying by means of wings.
...
This bracelet is made of seven empty, oblong, bronze plates the size
of a Hobbit's smallest finger and twice as wide which are connected by
bronze links. It must be worn on the left wrist for its magic to be
effective.

The wearer may increase their Cast Chance with spell magic by the
value of their Luck stat.

Each setting will hold a rectangular stone, but all must be different
and at least semi-precious. When all the settings are filled, it will
be a spell rack.
...
This small net-like decoration is about 15 cms long and 4 cms wide. It
is made from the dessicated sinews of a priestess of the Black Land
and although it only weighs 4 oz, it encumbers as if it weighed 1
lb. It is a spell rack.

It must be worn on the chest, either as a cloak pin for the left lapel
or brooch on the upper left torso for it to be effective.  The first
Healing spell the wearer receives in a day is enhanced to cure 3
damage points in addition to any other granted. This does not apply to
healing from potions, draughts or the Arts of Healers and Herbalists.
...
| WP         | PC         | PB         | TMR        | NA                        |
+------------+------------+------------+------------+---------------------------+
| 13         | 13         | 9          | 2          | Shell reduces damage by 6 |
+------------+------------+------------+------------+---------------------------+
