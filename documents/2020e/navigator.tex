\begin{Skill}[1.1]{navigator}{Navigator}
...
\precis{A navigator can determine all compass directions if they can
  view the stars.}
...
\precis{A navigator may always determine the compass direction of a
  landmark relative to their position.}
...
\precis{A navigator can read a map if they can relate their physical
...
\precis{The navigator may place themselves on a map if they can
...
\precis{A navigator can competently pilot a ship of up to (25 + 25 ×
  Rank) feet in length.}
...
\precis{A navigator can predict weather at sea with (PC + 5 × Rank)\%
  chance of accuracy.}
...
\precis{A navigator can sometimes recognise non-magical danger at sea
  before subjecting the ship to it.}
