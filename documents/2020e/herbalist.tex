\begin{Skill}[1.1]{herbalist}{Herbalist}
...
or for each rank of  ranger skill if the environment is the ranger’s speciality as per rule \S\ref{ranger:environments} & +2 \\
\end{dqtblr}
