...
Each point the Mage’s MA is greater than 15		& \pl 1 \\
Each point the Mage’s MA is less than 15		& \mi 1 \\
Each Rank the Mage has with the spell they are casting	& \pl 3 \\ 
Each hour the Mage engages in Ritual Spell preparation	& \pl 3 \\
\end{dqtblr}
...
Target and caster are of the same Branch of Magic			& \mi 5 \\
Target and caster are of opposed Branches of Magic			& \pl 5 \\
Target is sentient but not a Mage					& \pl 20 \\
Target is in a consecrated area						& \pl 50 \\
Target has on, or is in the area of, the appropriate counterspell	& + 30 +3/Rank \\
Spell had triple effect and the caster chose to affect Magic Resistance	& \mi 20 \\
\end{dqtblr}
