...
Action The movement and combat activity a figure may attempt during
one pulse.
\begin{Description}
...
\begin{Enumerate}
\item  Unengaged  Initiative  is  determined  for  each 
side. 

\item  If  any  figures  are  engaged  or  in  Close,  these 
...
\item[Announcements  of  Intent]  When  combat  occurs 
