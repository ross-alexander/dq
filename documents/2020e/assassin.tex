...
\precis{An assassin is trained in using envenomed weapons.}
...
\precis{An assassin increases their chance of causing a Grievous Injury as
...
\precis{An assassin may gain information from a victim through torture.}
...
\precis{An assassin is trained to improve their memory.}
...
\precis{An assassin is able to buy poisons, distilled venoms and acids at cost
(i.e. no mark-up) from an alchemist.}

\precis{An assassin inflicts increased damage on their target when attacking
...
\precis{An assassin increases their chance of knocking out a target.}
...
\precis{An assassin increases their chance of performing any action involving
