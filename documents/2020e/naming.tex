...
of spell to be dissipated, and the Adept must spec- ify the name of
the spell that they wish to remove.  If the Counterspell is
successfully cast, the chance of the magic being dispelled is 50\% [(+
  3 / Rank with Dispel Magic) (3 /Rank of the target magic)].  This
spell cannot remove the effects of rituals, or remove curses.
...
than they truly are.  True Seeing may reveal the visual com- ponent of
...
True Seeing is of higher Rank: More major imperfections may be
noticed.  (e.g.  invisible figures have a slight will-o’-the-wisp
glow, toads that are really Princes may have tiny gold crowns).  The
