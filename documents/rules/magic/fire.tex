...
\duration{Immediate}
\multiple{75}
\basechance{MA + 5 / Rank - 1 / 5 feet separating the Adept from the target (after the first 5 feet)}
\resist{Passive}
\begin{effects}
...
\target{Area}
\begin{effects}
The Adept may create a 5 foot high \x 20 foot long \x 1 foot thick
wall of flames, or a 5 foot high \x 1 foot thick circle of flames with
...
\resist{None}
\target{Entity}
\casttime{3 Hours - 10 minutes / Rank (minimum 10 minutes)}
\material{none}
\concentration{Standard}
\begin{effects}
