...
\index{alchemy!witchcraft special alchemy}
\begin{effects}
...
but the Base Chance is reduced by 20.  The storm front will take [D \x
3 - 1 / Rank] minutes to arrive.  Once the duration has expired, the
...
\index{fear!witchcraft mass fear}
...
from the ground.  The wall is 10 feet high \x 20 feet long \x 2 feet
...
\duration{8 hours \x Rank (minimum 1)}
\multiple{300}
