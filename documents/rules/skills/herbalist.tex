\begin{skill}{Herbalist}{1.0}{herbalist}
...
skill is (Perception \x 2 + Rank \x 15 - 10 \x the minimal rank at
...
the Rank of the ability the herb is used for \x 5 - herbalist Rank \x
2.  If the herbalist wishes to perform a particular ability in an
...
to be used \x 5 months - Rank of the herbalist \x 3 weeks.
...
for rare herbs Rank / 2 days and for very rare herbs Rank \x 2 hours.
...
endurance as per the healer skill.  This potion will last Rank \x 3
...
\index{resurrection!herbalist restore life}
...
last for Rank \x 4 hours.  This potion will last for Rank weeks, and it
will take 24 hours to prepare Rank / 2 (round up) doses.

\item At Rank 2 a herbalist may prepare, using uncommon herbs, a
potion that will induce sleep for up to Rank \x 2 hours unless the
...
\ie no down-side.  These potions will last for Rank \x 2 weeks, and
it will take 48 hours to prepare Rank / 4 (round up) doses.
\index{potions!stat increase}
...
Such perfumes will only mildly modify (plus or minus Rank \x 4\% to
...
to act for Rank \x 3 hours once applied.  It will take 24 hours to
...
Rank \x 2 minutes (damage is applied at the end of each minute).  It
...
\x 2 pulses. Or using rare herbs a poison that will cause [D - 3] +
(Rank / 2, round up) damage per pulse, for Rank \x 2 pulses. If the
...
will become a spectre.  This potion will last for Rank \x 2 days, and
it will take 48 hours to prepare Rank / 4 (round up) doses.
